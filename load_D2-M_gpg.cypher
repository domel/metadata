...
CALL apoc.import.csv(
  [
    {fileName:'http://localhost:8000/D2-M/gpg/nodes_entities.csv', labels:['Entity']},
    {fileName:'http://localhost:8000/D2-M/gpg/nodes_sources.csv',  labels:['Source']}
  ],
  [
    {fileName:'http://localhost:8000/D2-M/gpg/rels_rel.csv', type:'REL'}
  ],
  {
    delimiter: ',',
    arrayDelimiter: ';',
